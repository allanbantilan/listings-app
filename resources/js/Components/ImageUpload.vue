...
<template>
    <div>
        ...
        <label
            for="image"
            class="block rounded-md mt-1 bg-slate-300 h-[138px] overflow-hidden cursor-pointer border-slate-300 border
            relative"
