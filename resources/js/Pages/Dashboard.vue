...
<template>
                ...
                >
                    ...
                    <tbody>
                        <tr
                            ...
                            :key="listing.id"
                            class="border-b bordesalte200 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-600 dark:border-slate-600"
                        >
    ...
    <div v-else>
        Due to violation of out terms your account has been suspended, please
