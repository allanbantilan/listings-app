...
<template>
    ...
    <div class="mb-6">
        ...
        <div class="flex items-end justify-between">
            <div class="flex items-endd gap-2">
                <!-- search form  -->
                ...
                <Link
                    class="px-2 py-[6px] rounded-md bg-indigo-500 dark:bg-indigo-700 text-white flex items-center gap-2"
                    v-if="params.search"
                    :href="
                        route('user.show', {
                            ...params,
    ...
    >
        ...
        <tbody class="divide-y divide-slate-300 divide-slashed">
            <tr v-for="listing in listings.data" :key="listings.id">
